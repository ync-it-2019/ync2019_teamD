  ...
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
		...
		<div class="col-md-3 products-left" style="margin:0 50px 0 0;">
			...
			<form id='searchForm2' action="/front/culture_project" method='get'>
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> 진행중인 프로젝트</label>
						<ul><!-- 작업포인트 -->
							<li><input type="submit" name='keyword' value="모임"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>모임</li>
							<li><input type="submit" name='keyword' value="공연/컬쳐"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>공연/컬쳐</li>
							<li><input type="submit" name='keyword' value="소셜/캠페인"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>소셜/캠페인</li>
							<li><input type="submit" name='keyword' value="게임/취미"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>게임/취미</li>
							<li><input type="submit" name='keyword' value="출판"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>출판</li>
						</ul>
					</li>
				</ul>
			</div>
