	...
	<div class="row">
		<nav class="col-sm-3 col-4" id="myScrollspy">
			<ul class="nav nav-pills flex-column"><br><br><br>
				<li class="nav-item">
					<a class="nav-link active" href="#section1" style="visibility: hidden;">분야 설정</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#section2"style="visibility: hidden;">간략 소개</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#section3"style="visibility: hidden;">프로젝트</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#section4"style="visibility: hidden;">상세 설명</a>
				</li>
			</ul>
		</nav>
		<div class="col-sm-9 col-8">
			<div id="section1">
				...
				<form class="submitProject" action="project_write_finish" method="post">
					...
					<br><br>
					<!-- <a href='#' class='nextButton'>다음 단계</a> -->

			</div>
			<div id="section2">
				<br><br><br><div class="sort-grid"></div>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="jumbotron">
							...
							<input type="file" class="setSize60"><br>
						</div>
					...
					<h3>프로젝트 상세 내용</h3><br>
					<textarea name="detail_content" rows="12" cols="80"></textarea>
				</div><br><br>
