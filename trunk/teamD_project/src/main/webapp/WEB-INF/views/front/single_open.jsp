				...
				<div class="col-md-4-1" style="float: top; width: 100%; height:40%;">
					...
					<h3>
						<span class="item_price"> <!--날짜 계산  --> <jsp:useBean
								...
								var="nowDate"></fmt:parseNumber> ${strDate - nowDate} 일 남음<!--날짜 계산 end  -->
						</span>
					</h3>
					<p>
						<span style="font-size: 25px;"><c:out value="${openDate}"/>일부터 펀딩 시작</span>
					</p>
					<br> <br>
					<p>
						목표금액 <span style="font-size: 25px;"><fmt:formatNumber value="${project.achive_invest}" pattern="#,###,###,###,###" />원</span>
					</p>
					<br>
				</div>
