...
<body>
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">프로젝트 삭제 신청 목록</h1>
        </div>
    ...
    <thead>
      <tr>
        ...
        <th onclick="w3.sortHTML('#removeProjectTable', '.item', 'td:nth-child(2)')" style="cursor:pointer">카테고리</th>
        <th onclick="w3.sortHTML('#removeProjectTable', '.item', 'td:nth-child(3)')" style="cursor:pointer">프로젝트 명</th>
        <th>시작일</th>
        <th>종료일</th>
        <th onclick="w3.sortHTML('#removeProjectTable', '.item', 'td:nth-child(6)')" style="cursor:pointer">회사명</th>
        <th>현재 금액</th>
        <th>목표 금액</th>
        <th>관리</th>
      </tr>
