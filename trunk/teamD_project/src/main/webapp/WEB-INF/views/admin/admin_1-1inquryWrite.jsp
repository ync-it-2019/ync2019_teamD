...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="cleans" style="margin-top:10%;"></div>
        <!-- 작성자 -->
      ...
      <div class="col-sm-2">
        <a href="admin_1-1inquryWrite.html"><button type="button" class="btn btn-success">답변</button></a>
      </div>
      <div class="col-sm-2">
         <a href="admin_1-1inqury.html"><button type="button" class="btn btn-danger">뒤로</button></a>
      </div>
      <div class="col-sm-4"></div>
    </div>
    <!-- /#page-wrapper -->
