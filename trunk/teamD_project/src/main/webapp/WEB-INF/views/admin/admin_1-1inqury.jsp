        ...
        <table class="table table-hover" id="1-1inquryTable">
          <thead>
            ...
            <tr class="item">
              ...
              <th onclick="w3.sortHTML('#myTable', '.itemss', 'td:nth-child(3)')" style="cursor:pointer">작성자</th>
              <th onclick="w3.sortHTML('#myTable', '.itemss', 'td:nth-child(4)')" style="cursor:pointer">등록일자</th>
              <th onclick="w3.sortHTML('#myTable', '.itemss', 'td:nth-child(5)')" style="cursor:pointer">답변유무</th>
            </tr>
          </thead>
          <tbody>
