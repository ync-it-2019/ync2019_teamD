		...
		<div class="col-md-4">
			...
			<form role="form" method='post' action="/login">
				<fieldset>
					...
					<div class="form-group">
						<input class="form-control" placeholder="userpw" name="password"
							type="password" value="">
					</div>
					<div class="checkbox">
			...
			<div class="styled-input">
				<p>
					<br> <font size="2em" color="gray">아직 계정이 없으신가요?</font>&nbsp;

					<a href="join"> <font size="4em" color="black"><ins>
								회원가입 </ins></font>
					</a>
					<br><br><br><br><br><br>
					<a href="../" class="btn btn-warning btn-lg btn-block">메인으로</a>
				</p>
			</div>
		</div>
