...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">마감 된 프로젝트 목록</h1>
			</div>
							...
							<td>
								<form action="/admin/delete" method="post">
									<input type="hidden" name="${_csrf.parameterName}"
										...
										type="submit" value="[삭제]" onclick="alert('정말로 삭제처리하시겠습니까?')">
								</form>
							</td>
						</tr>
					</c:forEach>
