...
<body>
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">오픈 예정 프로젝트 목록</h1>
        </div>
    ...
    <thead>
      <tr>
        ...
        <th onclick="w3.sortHTML('#openTable', '.itemss', 'td:nth-child(2)')" style="cursor:pointer">카테고리</th>
        <th>프로젝트 명</th>
        <th>시작일</th>
        <th onclick="w3.sortHTML('#openTable', '.itemss', 'td:nth-child(5)')" style="cursor:pointer">회사명</th>
        <th>관리</th>
      </tr>
    </thead>
    <tbody>
      <c:forEach items="${project}" var="Project">
        ...
        <td>
          <form action="/admin/start" method="post">
          	...
          	<input type="submit" value="[시작]" onclick="alert('정말로 시작시키겠습니까?')">
          </form>
