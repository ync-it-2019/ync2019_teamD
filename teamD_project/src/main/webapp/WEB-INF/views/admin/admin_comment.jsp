...
<body>
    ...
    <thead>
      <tr>
        ...
        <th onclick="w3.sortHTML('#openTable', '.itemss', 'td:nth-child(2)')" style="cursor:pointer">프로젝트 명</th>
        <th>글 내용</th>
        <th onclick="w3.sortHTML('#openTable', '.itemss', 'td:nth-child(4)')" style="cursor:pointer">작성자</th>
        <th onclick="w3.sortHTML('#openTable', '.itemss', 'td:nth-child(5)')" style="cursor:pointer">작성일</th>
        <th>관리</th>
      </tr>
    </thead>
    <tbody>
