		...
		<div class="container">
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
					<h1 class="aboutLabel">내 프로젝트</h1>
					<p>프로젝트 정책과 포인트 지급에 대한 정보를 확인 할 수 있습니다.</p>
				</div>
			...
			<div class="col-md-2">
				<ul class="nav nav-pills">
					<li class="nav-item">
						<!-- <a class="nav-link active" href="#" onclick="mypageMyprojectING()">진행 중</a> -->
						<a class="nav-link active" id="ingBtn" href="#">진행 중</a>
					</li>
					<li class="nav-item">
						<!-- <a class="nav-link" href="#" onclick="mypageMyprojectEND()">종료</a> -->
						<a class="nav-link" id="endBtn" href="#">종료</a>
					</li>
				</ul>
			</div>
