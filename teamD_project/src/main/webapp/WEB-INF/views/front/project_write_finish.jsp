  ...
  <!-- banner-bootom-w3-agileits -->
    ...
    <!-- 메인화면 중 오른쪽 -->
		<div class="col-md-8 products-right">
			<h5>프로젝트 <span>등록</span></h5>
			<div class="sort-grid"></div>
			<div class="men-wear-top">
			</div>
			<div class="men-wear-bottom">
				<div class="jumbotron">
					<h2>프로젝트 검토 요청이 완료되었습니다.</h2><br>
					7일 이내에 검토하여 등록된 이메일로 검토 결과를 발송해드리니 기다려주세요.
				</div>
				<div class="col-sm-4 men-wear-left">
					<!-- <img class="img-responsive" src="resources/images/bb2.jpg" alt=" " /> -->
				</div>
			</div>
			<div class="row">
				<!-- 마이페이지로 이동 -->
				<a href="myPage" class="myPageButton" style="margin-left:5%;">마이페이지로</a>
				<!-- 인덱스로 이동 -->
				<a href="../" class="nButton"  style="margin-left:5%;">확인</a>
			</div>
			<br><br>
