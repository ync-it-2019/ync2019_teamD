...
<!-- /한눈에보기프로젝트-->
 	...
 	<div class="col-md-4 product-men" style="width:30%; margin: 30px 10px 10px 10px; cursor: pointer;" onclick="location.href='single_open?project_num=${project.project_num}'">
 							<div class="men-pro-item simpleCart_shelfItem">
 									...
 									<c:if test="${not empty project.title_image}">
 										...
 										<span class="product-new-top2">OPEN</span>

 								

 								<div class="item-info-product ">
 									<h4><a href="single_open?project_num=${project.project_num}"><c:out value="${project.simple_content}"></c:out></a></h4>
											...
											<p><c:out value="${project.category}"/></p>
											           ...
											           <div></div>
														...
														<div style="float: left; width: 55%; ">
															<fmt:formatNumber value="${project.achive_invest}" pattern="#,###,###,###,###"/>원 목표
														</div>
														<div style="float: right; width: 25%; ">
															<strong style="text-align: right"> ${strDate - nowDate} 일 후</strong>
														</div>
										</div>
