...
<html>
<head>
<title>Elite Shoppy an Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | total :: w3layouts</title>
<!--/tags -->
...
<br>
<hr>
<h3 class="wthree_text_info">오픈예정 <span>프로젝트</span></h3>
<hr>
...
<br>
<hr>
	  <h3 class="wthree_text_info">문화콘텐츠 <span>프로젝트</span></h3>
<hr>
<div class="col-md-4 product-men">
										<div class="men-pro-item simpleCart_shelfItem">
											<div class="men-thumb-item">
...
<div class="banner_bottom_agile_info team">
	<div class="container">
		<hr>
				<h3 class="wthree_text_info">종료 <span>프로젝트</span></h3>
		<hr>
